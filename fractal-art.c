...
#define CENTER_X 0.75 // X coordinate for image center
#define CENTER_Y -0.25 // Y coordinate for image center
#define SCALE 1 // maximum X value in the fractal graph
